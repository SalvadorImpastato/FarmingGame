...
public class UIInventoryBar : MonoBehaviour
{
    ...
    public void ClearHighlightOnInventorySlots()
    {
        ...
        {
            // Loop through inventory slots and clear highligh sprits
    ...
    public void SetHighlightedInventorySlots()
    {
        if (inventorySlot.Length > 0)
        {
            // Loop through inventort slots and clear highlight sprites
            for (int i =0; i < inventorySlot.Length; i++)
            {
                SetHighlightedInventorySlots(i);
            }
    ...
    /// <summary>
    /// Overloaded method - Set the selected highlight if set on all inventory item for a given slot item position
    /// </summary>
    public void SetHighlightedInventorySlots(int itemPosition)
    {
        if (inventorySlot.Length > 0 && inventorySlot[itemPosition].itemDetails != null)
        {
            ...
            {
                // Make highlight sprite fully visable by turning up the alpha
