...
public class InventoryManager : SingletonMonobehaviour<InventoryManager>
{
    ...
    {
        // If fromItem index and toItem index are within the bounds of the list, not the same, and greater tha or equal to zero
    ...
    ///<summary>
    /// Get the item type descriptionnfor an item type - returns the item type description as a string for a given ItemType
    /// </summary>
    ...
    /// <summary>
    /// Remove an item form the inventory, and create a game object at the position it was dropped
    /// </summary>
